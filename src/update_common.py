...
def fetch_and_merge(dataset_id, data_path, dedup_subset, sort_by, past_hours, forecast_hours,
    ...
    Pass keep_cols=None to store the response as-is -- used by the adequacy feed, where the
    whole point is the full generation-mix breakdown and picking a subset would defeat it."""
